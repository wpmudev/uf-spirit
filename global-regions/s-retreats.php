...
$s_retreats = upfront_create_region(
  ...
  'featured_image_url' => '{{upfront:style_url}}/images/global-regions/s-retreats/bg-retreats.jpg',
)
			);
...
<h5 style="text-align: right;">WELLNESS RETREATS</h5>
    ...
    'cached_html' => '<div class="upfront-editable_entity upfront-object c24 upfront-plain_txt default" id="object-1452647215418-1560" style="min-height: 125px; padding: 100px 15px 10px;">
...
<p style="text-align: right;">Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisi ut aliquip.</p>
    ...
    'row' => 11,
    'cached_html' => '<div class="upfront-editable_entity upfront-object c24 upfront-plain_txt default" id="object-1452647220463-1638" style="min-height: 55px; padding: 0px 15px;">
	<b class="upfront-entity_meta upfront-ui">
		<!--  <a href="#" class="upfront-icon-button upfront-icon-button-setting upfront-entity-settings_trigger"></a>  -->
