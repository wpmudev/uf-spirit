<?php
/* START_REGION_OUTPUT */
$region_df6f88 = upfront_create_region(
			array (
  'name' => 'header',
  'title' => 'Header',
  'type' => 'wide',
...
$region_df6f88->add_element("Uimage", array (
  'columns' => '3',
  'margin_left' => '0',
  'margin_right' => '0',
  'margin_top' => '0',
...
$region_df6f88->add_element("Unewnavigation", array (
  'columns' => '17',
  'margin_left' => '0',
  'margin_right' => '0',
  'margin_top' => '0',
...
$region_df6f88->add_element("Code", array (
  'columns' => '4',
  'margin_left' => '0',
  'margin_right' => '0',
  'margin_top' => '0',
...
.social-icon:before {
    ...
    background-image: url("{{upfront:home_url}}/wp-content/themes/uf-spirit/ui/sprite.svg"), none;
    width: 35px;
    height: 35px;
    display: block;
}
