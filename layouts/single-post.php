...
"rows" => 5, 
"options" => array(
	"src" => "" . get_stylesheet_directory_uri() . "/images/single-post/logo-nav-105x42-8582.png", 
	"srcFull" => "" . get_stylesheet_directory_uri() . "/images/single-post/logo-nav.png", 
	"srcOriginal" => "" . get_stylesheet_directory_uri() . "/images/single-post/logo-nav.png", 
	"image_title" => "", 
	"alternative_text" => "", 
	"when_clicked" => false, 
	"image_link" => "", 
...
"options" => array(
	"view_class" => "PlainTxtView", 
	"id_slug" => "plain_text", 
	"content" => "<p class=\"\">2014 MEG CAMPBEL</p>", 
	"type" => "PlainTxtModel", 
