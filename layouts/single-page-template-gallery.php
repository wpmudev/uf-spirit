...
"options" => array(
	...
	"images" => array(array(
			...
			"sizes" => array(
				...
				"custom" => array(
					"error" => false, 
					"url" => "" . get_stylesheet_directory_uri() . "/images/single-page-template-gallery/photo1 (1)-140x140-9117.jpg", 
			...
			"src" => "" . get_stylesheet_directory_uri() . "/images/single-page-template-gallery/photo1 (1)-180x180-4342.jpg", 
			"loading" => false, 
			"status" => "ok", 
